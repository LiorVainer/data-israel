...
=== תאריך עדכון אחרון ===
- כשמציג מאגרי נתונים, השתמש ב-getDatasetDetails כדי לשלוף את שדה metadata_modified — זהו תאריך העדכון האחרון של המאגר
...
2. בדוק פרטי המאגרים שמצאת (כולל תאריך עדכון אחרון)
