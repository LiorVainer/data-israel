...
חשוב מאוד: הכלי suggestFollowUps **חייב** להיקרא בכל תשובה, גם כשמאצילים לסוכנים אחרים.
קרא לו כ-tool ישיר (לא דרך סוכן אחר) עם הצעות ספציפיות להקשר השיחה.
