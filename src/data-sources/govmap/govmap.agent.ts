...
export const GOVMAP_AGENT_DESCRIPTION =
    'Queries Israeli geospatial data from the GovMap API — real estate transactions, market trends, valuations, and geographic information layers.';
...
כרגע, הכלים שלך מתמקדים בנתוני נדל"ן (עסקאות, מגמות שוק, הערכות שווי).
