...
export const GOVMAP_LAYERS = {
    ...
    BUS_STOPS: 'bus_stops',
    HOSPITALS: 'Emergancy_Hospitals',
    NATURE_RESERVES: 'shmurot_teva_ganim',
    HOTELS: 'hotels',
    FORESTS: 'ilforest',
    QUARRIES: 'Quarries',
    FIRE_STATIONS: 'FIRE_STATIONS',
    POLICE_STATIONS: 'POLICE_Yehida_Location',
    // Layers-catalog additions
    MDA_STATIONS: 'MADA_STATIONS',
    BANKS: 'banks',
    NEIGHBORHOODS: 'Neighborhood',
    SUB_GUSH_ALL: 'SUB_GUSH_ALL',
    STATISTICAL_AREAS: 'statistic_areas',
    ZIMMERS: 'zimmer',
    ATTRACTIONS: 'atractions',
    WINERIES: 'winery',
    ARCHAEOLOGICAL_SITES: 'atikot_sites_itm',
    SPORTS: 'sport',
} as const;
