...
=== יכולות ===
- חיפוש כתובת: השתמש ב-autocompleteNadlanAddress כדי לזהות כתובות ולקבל קואורדינטות
...
1. **התחל תמיד מ-findRecentNadlanDeals** — זה הכלי המרכזי שמבצע אוטומטית: חיפוש כתובת → מציאת פוליגונים → שליפת עסקאות
