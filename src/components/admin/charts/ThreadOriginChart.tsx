...
import type { ThreadOriginEntry } from '@/convex/analytics';
...
interface ThreadOriginChartProps {
    data: ThreadOriginEntry[];
    isMobile: boolean;
}
...
export function ThreadOriginChart({ data, isMobile }: ThreadOriginChartProps) {
    ...
    return (
        <div>
            <h3 className='mb-4 text-sm font-medium text-muted-foreground'>מקור שיחות</h3>
